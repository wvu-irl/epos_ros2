...
class Metaclass_MotorCommands(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('epos_ros2_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'epos_ros2_msgs.msg.MotorCommands')
            logger.debug(
            ...
            from epos_ros2_msgs.msg import MotorCommand
...
class MotorCommands(metaclass=Metaclass_MotorCommands):
    ...
    _fields_and_field_types = {
        'commands': 'sequence<epos_ros2_msgs/MotorCommand>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['epos_ros2_msgs', 'msg'], 'MotorCommand')),  # noqa: E501
    )
