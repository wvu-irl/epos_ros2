...
bool epos_ros2_msgs__msg__motor_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("epos_ros2_msgs.msg._motor_command.MotorCommand", full_classname_dest, 46) == 0);
  }
  epos_ros2_msgs__msg__MotorCommand * ros_message = _ros_message;
  {  // drive_mode
    ...
    rosidl_runtime_c__String__assign(&ros_message->drive_mode, PyBytes_AS_STRING(encoded_field));
  ...
  {  // motor_id
    ...
    ros_message->motor_id = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // command
...
PyObject * epos_ros2_msgs__msg__motor_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("epos_ros2_msgs.msg._motor_command");
  ...
  {  // drive_mode
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->drive_mode.data,
      strlen(ros_message->drive_mode.data),
      "strict");
    if (!field) {
      return NULL;
    }
