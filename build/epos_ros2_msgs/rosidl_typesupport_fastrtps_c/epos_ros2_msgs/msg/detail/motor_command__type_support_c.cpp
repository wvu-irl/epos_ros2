...
#include "epos_ros2_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // drive_mode
#include "rosidl_runtime_c/string_functions.h"  // drive_mode

// forward declare type support functions


using _MotorCommand__ros_msg_type = epos_ros2_msgs__msg__MotorCommand;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->drive_mode;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: drive_mode
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->drive_mode.data) {
      rosidl_runtime_c__String__init(&ros_message->drive_mode);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->drive_mode,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'drive_mode'\n");
      return false;
    }
  }
...
static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_epos_ros2_msgs__msg__MotorCommand(
...
{
  return max_serialized_size_epos_ros2_msgs__msg__MotorCommand(
    full_bounded, 0);
}
